...
<form action="?page=salvar-venda" method="POST">
	...
	<div class="mb-3">
		<label>Data
			<input type="date" name="data_venda" class="form-control" value="<?php echo $row->data_venda; ?>">
		</label>
	</div>
	...
	<div class="mb-3">
		<label>Valor
			<input type="number" name="valor_venda" class="form-control" value="<?php echo $row->valor_venda; ?>">
		</label>
	</div>
