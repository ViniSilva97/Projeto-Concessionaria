Aluno: Vinicius Gonçalves de Silva
# Documentação Complementar
## ##  Projeto Acadêmico - desenvolvido com aplicação de CRUD

Projeto desenvolvido com finalidade de ser um **Sistema de Gerenciamento de informações de uma Concessionária** desenvolvido em PHP com MySQL, implementando operações CRUD (Create, Read, Update, Delete) para gerenciamento de: 
...
### CRUD usado na construção do projeto

Foram implementadas para cada módulo as quatro operações básicas:
...
4. **Interface**: Utiliza Bootstrap + CSS independente para criação de interface responsiva
...
*   **Vinicius Gonçalves de Silva** - *Matrícula: 45963053*

**Disciplina:** Programação Web/Tecnicas de Programação
...
<img width="1000" height="532" alt="image" src="https://github.com/user-attachments/assets/f11e9a80-83e0-41bc-8afe-fe418212e48a" />
